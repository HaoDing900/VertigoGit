...
class FILMEMULATOR_API FFilmEmulatorPrintPS : public FGlobalShader
{
public:
    DECLARE_GLOBAL_SHADER(FFilmEmulatorPrintPS);
    SHADER_USE_PARAMETER_STRUCT(FFilmEmulatorPrintPS, FGlobalShader);
