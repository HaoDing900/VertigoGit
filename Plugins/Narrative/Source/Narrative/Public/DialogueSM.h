...
public:
	...
	*/
	...
	//Add Profile Picture Expression to Speakers 
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Speaker Details")
	UTexture2D* ProfilePictureExpression = nullptr;

	//Add Icon Picture to Speakers 
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Speaker Details")
	UTexture2D* Icon = nullptr;

	//Add Response Profile Picture to Speakers 
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Speaker Details")
	UTexture2D* ResponsePicture = nullptr;

	//Add CharacterReactionvfx Picture to Speakers 
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Speaker Details")
	UPaperSprite* CharacterReactionvfx = nullptr;
	
	//Add vfx Picture to Speakers 
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Speaker Details")
	UPaperSprite* vfx = nullptr;
